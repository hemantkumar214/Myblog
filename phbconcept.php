                        ...
                        <div class="mydiv1" <?php echo "id=b" . $row[0] . "" ?> >                
                           ...
                           <div class="space"></div>
                            ...
                            <div  class="row detail"  style="background-color:	#F8F8F8  ;border-bottom-style: groove;     bottom: 0; left: 20px;  height:30px;">
                                ...
                                <div> <a href="#" style=" color:#339966; " <?php echo "id=" . $row2[0] . "" ?>  onclick="deletecomment(this.id)" >Delete</a></div>
                           ...
                           <div  class="row detail"  style="background-color:	#F8F8F8  ;border-bottom-style:groove;     bottom: 0; left: 20px;  height:30px;">
                                ...
                                <div> <a href="#" style=" color:#339966; " <?php echo "id=" . $row2[0] . "" ?>  onclick="deletecomment(this.id)" >Submit</a></div>
